...
- configmap gizli olmayan verileri tutatbiliriz.
...
### kubectl delete confogmaps myconfigmap
- silme
...
### Pod Affinity
- istedigimiz podun istedigimiz node ustunde kosan poslara gore olusturulmasini ya da olusturulmamasini isteyebiliriz.
...
- Retain: kullanildiktan sonra oldugu gibi kaliyor. Burdan baska bir yere tasiyabiliyoruz.
  Recycle: volume silinmiyor ama icndeki dosyalar siliniyor. tekrar kullanabiliyoruz.
...
- container dail ederse yeniden olusturur.
...
- Kubernetes uztunde user olusturma yok.
...
- csr olusturma, certificate sign request, sertifika saglayiciya bana bu ozelliklerde sertifika sagla demek. imzalyip onaylayip bize sertifikimizai admin gonderecek. 
...
- role api uzerinde bir kubernetes objevti ile ilgili izinleri tanimlayabiliyoruz. namespace belirtiriz.
...
- pod kube-api servera ulsabilsin diye kubernetes isimli bir service oluturulur.
